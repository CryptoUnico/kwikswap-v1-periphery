...
contract ExampleSwapToPrice {
    ...
    IKwikswapV1Router01 public immutable router;
    address public immutable factory;

    constructor(address factory_, IKwikswapV1Router01 router_) public {
        factory = factory_;
        router = router_;
    }
    ...
    function swapToPrice(
        ...
        uint256 amountIn;
        {
            (uint256 reserveA, uint256 reserveB) = KwikswapV1Library.getReserves(factory, tokenA, tokenB);
